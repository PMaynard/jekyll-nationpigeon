...
date: 2008-01-24 15:15:20 +00:00
categories: 
- Programming
- Projects
author_email: pgm987@gmail.com
wordpress_url: http://www.nationpigeon.com/archives/43
author_url: http://nationpigeon.com
status: publish
---
Okay I have writen some basic IP code, they are included in the file upload's.
<ul>
	<li>Find Local IP Address</li>
	<li>Resolve IP Address</li>
	<li>Find Domain IP Address</li>
	<li>User Argument Example</li>
</ul>
Hope this helps.

<a href="http://www.nationpigeon.com/wordpress/wp-content/uploads/2008/01/basicip.zip" title="Basic IP (ZIP)">Basic IP (ZIP)</a>
